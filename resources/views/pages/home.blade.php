            ...
            <div class="w-full border rounded-lg p-2">
                <div class="row p-2">
                    <div class="w-full flex items-end pb-2 justify-content-center">
                        <div class="text-lg font-normal ">OVERALL </div>
                    </div>
                ...
                <div class="row p-2">
                    <div class="col-md-6">
                        <div class="w-full flex items-end pb-2 justify-content-center">
                            <div class="text-lg font-normal ">MARGINS </div>
                        </div>
                        <div class="space-y-1 flex flex-col items-start sticky left-0 z-10">
                            <div class="flex flex-row shrink-0 w-full px-1 text-xs font-light">
                                <div class="flex truncate">Market Capitalization</div>
                        ...
                        <div class="w-full flex items-end pb-2 justify-content-center border-b">
                            <div class="text-lg font-normal ">VALUATION RATIOS </div>
                        </div>
                        <div class="space-y-1 flex flex-col items-start sticky left-0 z-10">
                            <div class="flex flex-row shrink-0 w-full px-1 text-xs font-light">
                                <div class="flex truncate">Market Capitalization</div>
                        ...
                        <div class="w-full flex items-end pb-2 justify-content-center border-b">
                            <div class="text-lg font-normal ">BALANCE SHEET 10YR MEDIAN </div>
                        </div>
                        <div class="space-y-1 flex flex-col items-start sticky left-0 z-10">
                            <div class="flex flex-row shrink-0 w-full px-1 text-xs font-light">
                                <div class="flex truncate">Market Capitalization</div>
                    ...
                    <div class="col-md-6">
                        <div class="w-full flex items-end pb-2 justify-content-center">
                            <div class="text-lg font-normal ">BALANCE SHEET </div>
                        </div>
                        <div class="space-y-1 flex flex-col items-start sticky left-0 z-10">
                            <div class="flex flex-row shrink-0 w-full px-1 text-xs font-light">
                                <div class="flex truncate">Market Capitalization</div>
            ...
            <div class="w-full  border rounded-lg  p-2">
                ...
                <div class="w-full flex-col items-end ">
                    ...
                    <div class="w-full flex items-end pb-2">
                        <div class="text-lg font-normal text-left">Company Description </div>
                    </div>
                    <div class="w-full flex flex-wrap justify-items-start ">
                        <div class=" flex-col space-y-1 py-2 pr-4">
                            <div class="w-full flex text-light text-xs text-left">
